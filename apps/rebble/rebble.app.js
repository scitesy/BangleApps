  ...
  require("heatshrink").decompress(atob("mEwwkBiIA/AH4AZUAIWUiAXBWqgXXdIYuVGCgXBgICCIyYXCJCQTDC6QrEMCQSEJCQRFC6ApGJCCiDDQSpQFAYXEJBqNGJCA/EC4ZIOEwgXFJBgNEAhKlNAgxIKBgoXEJBjsLC5TsIeRycMBhRrMMBKzQEozjOBxAgHGww+IA6wfSH4hnIC47OMSJqlRIJAXCACIXaGoQARPwwuTAH4A/ABw"));
    ...
    let drawSideBar3=function() {
      ...
      if(currentWeather) {
        ...
        setSmallFont();
        g.setFontAlign(0, -1);
        g.drawImage(chooseIconByCode(currentWeather.hourlyforecast[0].weatherCode), w2 + ws/2, 1, { scale: .55 });
        g.drawString(currentWeather.hourlyforecast[0].temperature.toFixed(0), 130, 7);
        g.drawImage(chooseIconByCode(currentWeather.hourlyforecast[1].weatherCode), w2 + ws/2, 20, { scale: .55 });
        g.drawString(currentWeather.hourlyforecast[1].temperature.toFixed(0), 130, 26);
        g.drawImage(chooseIconByCode(currentWeather.hourlyforecast[2].weatherCode), w2 + ws/2, 39, { scale: .55 });
        g.drawString(currentWeather.hourlyforecast[2].temperature.toFixed(0), 130, 45);
        g.drawImage(chooseIconByCode(currentWeather.hourlyforecast[3].weatherCode), w2 + ws/2, 58, { scale: .55 });
        g.drawString(currentWeather.hourlyforecast[3].temperature.toFixed(0), 130, 64);
        g.drawImage(chooseIconByCode(currentWeather.hourlyforecast[4].weatherCode), w2 + ws/2, 77, { scale: .55 });
        g.drawString(currentWeather.hourlyforecast[4].temperature.toFixed(0), 130, 83);
        g.drawImage(chooseIconByCode(currentWeather.hourlyforecast[5].weatherCode), w2 + ws/2, 96, { scale: .55 });
        g.drawString(currentWeather.hourlyforecast[5].temperature.toFixed(0), 130, 102);
        g.drawImage(chooseIconByCode(currentWeather.hourlyforecast[6].weatherCode), w2 + ws/2, 115, { scale: .55 });
        g.drawString(currentWeather.hourlyforecast[6].temperature.toFixed(0), 130, 121);
        g.drawImage(chooseIconByCode(currentWeather.hourlyforecast[7].weatherCode), w2 + ws/2, 134, { scale: .55 });
        g.drawString(currentWeather.hourlyforecast[7].temperature.toFixed(0), 130, 140);
        g.drawImage(chooseIconByCode(currentWeather.hourlyforecast[8].weatherCode), w2 + ws/2, 153, { scale: .55 });
        g.drawString(currentWeather.hourlyforecast[8].temperature.toFixed(0), 130, 159);
      } else {
        drawBattery(w2 + (w-w2-wb)/2,  h/10, wb, 17);
        setTextColor();
        g.setFont('Vector', 20);
    ...
    let drawSideBar4=function() {
      ...
      if(currentWeather) {
        ...
        g.drawString(currentWeather.dailyforecast[0].maxTemperature.toFixed(0) + "|" + currentWeather.dailyforecast[0].minTemperature.toFixed(0), w3, 37);
        g.drawImage(chooseIconByCode(currentWeather.dailyforecast[1].weatherCode), w2 + (ws - 49)/2, 60, { scale: .75 });
        g.drawString(currentWeather.dailyforecast[1].maxTemperature.toFixed(0) + "|" + currentWeather.dailyforecast[1].minTemperature.toFixed(0), w3, 97);
        g.drawImage(chooseIconByCode(currentWeather.dailyforecast[2].weatherCode), w2 + (ws - 49)/2, 120, { scale: .75 });
        g.drawString(currentWeather.dailyforecast[2].maxTemperature.toFixed(0) + "|" + currentWeather.dailyforecast[2].minTemperature.toFixed(0), w3, 157);
      } else {
        drawBattery(w2 + (w-w2-wb)/2,  h/10, wb, 17);
        setTextColor();
        g.setFont('Vector', 20);
